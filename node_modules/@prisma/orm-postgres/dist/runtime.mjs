...
import { n as buildPostgresStaticContext, t as buildNamespacedNativeEnums } from "./postgres-static-KmLmp8vV-qgkhJAEz.mjs";
import { t as PostgresRuntimeImpl } from "./postgres-runtime-oM2EIAjm-CZIDUstk.mjs";
...
import { orm, prepareQuery } from "@prisma/orm-family-sql/orm-client";
import { Pool } from "pg";
...
function resolveOptionalPostgresBinding(options) {
	...
	return resolvePostgresBinding(blindCast(options));
}
...
function postgres(options) {
	...
	function prepare(declaration, callback) {
		return prepareQuery(getRuntime(), declaration, callback);
	}
	return {
		sql: sql$1,
		orm: orm$1,
