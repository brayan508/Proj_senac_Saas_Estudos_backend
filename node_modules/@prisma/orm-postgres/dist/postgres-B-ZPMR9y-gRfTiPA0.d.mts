...
import { BindSiteParams, Declaration, ExecutionContext, ParamsFromDeclaration, Runtime, SqlExecutionStackWithDriver, SqlMiddleware, SqlRuntimeExtensionDescriptor, TransactionContext, VerifyMarkerOption } from "@prisma/orm-family-sql/runtime";
import { PreparedFrom, orm } from "@prisma/orm-family-sql/orm-client";
...
import { Preparable, SqlQueryPlan } from "@prisma/orm-family-sql/relational-core/plan";
//#region ../../../3-extensions/postgres/dist/postgres-B-ZPMR9y.d.mts
...
interface PostgresClient<TContract extends Contract<SqlStorage>> {
  ...
  prepare<D extends Declaration<CT>, Q extends SqlQueryPlan | Preparable<unknown, unknown>, CT extends CodecTypesBase = ExtractCodecTypes<TContract>>(declaration: D, callback: (params: BindSiteParams<D>) => Q): Promise<PreparedFrom<ParamsFromDeclaration<D, CT>, Q>>;
  close(): Promise<void>;
...
//# sourceMappingURL=postgres-B-ZPMR9y-gRfTiPA0.d.mts.map