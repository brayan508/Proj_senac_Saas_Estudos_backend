...
import { CheckNode, ColumnRef, ComposedAuthoringHelpers, ComposedAuthoringHelpers as ComposedAuthoringHelpers$1, ContractDefinition, ContractInput, ContractInput as ContractInput$1, ContractModelBuilder, EnumMember, EnumTypeHandle, EnumTypeHandle as EnumTypeHandle$1, FieldNode, ForeignKeyNode, IndexConstraint, IndexNode, MergeEnums, ModelLike, ModelNode, PrimaryKeyNode, RelationNode, ScalarFieldBuilder, ScalarFieldBuilder as ScalarFieldBuilder$1, UniqueConstraintNode, autoincrement, buildBoundContract, buildSqlContractFromDefinition, check, field, member, model, now, rel, sql } from "@prisma/orm-family-sql/contract-ts/contract-builder";
...
import { FullTextSearchLanguage } from "@prisma/orm-target-postgres/target/operation-types";
...
declare const enumType: BoundEnumType<{
  ...
  readonly "pg/timestamptz-date@1": Pick<{
    readonly input: Date;
...
//#endregion
//#region src/contract/full-text-index.d.ts
 ...
 */
declare function fullTextIndex<const Name extends string>(column: ColumnRef, options: FullTextIndexNameOptions<Name>): IndexConstraint<never, Name>;
declare function fullTextIndex(column: ColumnRef, options: FullTextIndexMapOptions): IndexConstraint<never, undefined>;
//#endregion
