import { t as SqlLoweringSpec } from "./index-Cef8iy1o.mjs";
import { ParamSpec } from "@prisma/orm-framework/operations";
import { Codec, CodecCallContext, CodecCallContext as CodecCallContext$1, CodecDescriptor, CodecDescriptor as CodecDescriptor$1, CodecDescriptorTemplate, CodecInstanceContext, CodecRef, CodecRef as CodecRef$1, CodecTrait, CodecTrait as CodecTrait$1 } from "@prisma/orm-framework/components/codec";
//#region ../../../2-sql/4-lanes/relational-core/dist/types-YGX78yVc.d.mts
...
type AnyCodecDescriptorTemplate = CodecDescriptorTemplate<any>;
...
type BinaryOp = 'eq' | 'neq' | 'isNotDistinctFrom' | 'isDistinctFrom' | 'gt' | 'lt' | 'gte' | 'lte' | 'like' | 'in' | 'notIn';
...
declare class PreparedParamRef extends Expression {
  ...
  constructor(name: string, codec: CodecRef$1, nullable?: boolean);
  static of(name: string, codec: CodecRef$1, nullable?: boolean): PreparedParamRef;
  accept<R>(visitor: ExprVisitor<R>): R;
  rewrite(rewriter: ExpressionRewriter): AnyExpression;
  fold<T>(folder: ExpressionFolder<T>): T;
}
...
//#endregion
export { InsertValue as $, DefaultValueExpr as A, SqlCodecInstanceContext as At, EqColJoinOn as B, aggregateFnNames as Bt, CodecCallContext$1 as C, RawQueryAst as Ct, CodecTrait$1 as D, SelectAst as Dt, CodecRef$1 as E, RawSqlLiteral as Et, DescriptorCodecJson as F, ToWhereExpr as Ft, ExpressionSource as G, queryAstKinds as Gt, ExprVisitor as H, isAggregateFn as Ht, DescriptorCodecTraits as I, UpdateAst as It, FunctionSource as J, ExtractCodecTypes as K, whereExprKinds as Kt, Direction as L, WhereArg as Lt, DerivedTableSource as M, SubqueryExpr as Mt, DescriptorCodecId as N, TableRef as Nt, ColumnRef as O, SelectAstOptions as Ot, DescriptorCodecInput as P, TableSource as Pt, InsertOnConflict as Q, DoNothingConflictAction as R, WindowFn as Rt, Codec$1 as S, RawExpr as St, CodecJsonValueProjection as T, RawQueryResult as Tt, ExpressionFolder as U, isQueryAst as Ut, ExistsExpr as V, frozenCodecRef as Vt, ExpressionRewriter as W, isWhereExpr as Wt, IdentifierRef as X, FunctionSourceAlias as Y, InsertAst as Z, BinaryExpr as _, OrderByItem as _t, AndExpr as a, JsonObjectExpr as at, CaseExpr as b, ProjectionExpr as bt, AnyExpression as c, ListExpression as ct, AnyInsertValue as d, LoweredStatement as dt, JoinAst as et, AnyJsonValueProjection as f, NativeJsonValueProjection as ft, AstRewriter as g, OrExpr as gt, AnyQueryAst as h, OperationExpr as ht, AggregateOpFn as i, JsonObjectEntry as it, DeleteAst as j, SqlColumnRef as jt, ContractCodecRegistry as k, SqlCodecCallContext as kt, AnyFromSource as l, LiteralExpr as lt, AnyParamRef as m, NullCheckExpr as mt, AggregateExpr as n, JsonArrayAggExpr as nt, AnyCodecDescriptor$1 as o, JsonValueProjectionVisitor as ot, AnyOperationArg as p, NotExpr as pt, FunctionCallExpr as q, AggregateFn as r, JsonDocumentProjection as rt, AnyCodecDescriptorTemplate as s, LimitOffsetValue as st, AggregateCountFn as t, JoinOnExpr as tt, AnyInsertOnConflictAction as u, LoweredParam as ut, BinaryOp as v, ParamRef as vt, CodecDescriptor$1 as w, RawQueryColumn as wt, CastExpr as x, ProjectionItem as xt, CaseBranch as y, PreparedParamRef as yt, DoUpdateSetConflictAction as z, WindowFuncExpr as zt };
//# sourceMappingURL=types-YGX78yVc-LY1JQLED.d.mts.map