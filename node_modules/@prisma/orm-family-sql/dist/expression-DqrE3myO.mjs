import { E as OperationExpr, M as RawExpr, N as RawQueryAst, k as ParamRef } from "./types-ZNKYVjLr-DzjvSHKB.mjs";
...
function codecOf(value) {
	if (!isExpression(value)) return void 0;
	return value.returnType?.codec ?? (value.returnType?.codecId ? { codecId: value.returnType.codecId } : void 0);
}
...
//#endregion
export { param as a, isExpression as i, codecOf as n, toExpr as o, createRawSql as r, buildOperation as t };

//# sourceMappingURL=expression-DqrE3myO.mjs.map