...
import { r as SqlOperationDescriptors } from "./index-Cef8iy1o.mjs";
import { h as AnyQueryAst } from "./types-YGX78yVc-LY1JQLED.mjs";
import { o as SqlExecuteRequest } from "./driver-types-BQtRkOJ0-Bv2RPSfr.mjs";
import { s as DdlNode } from "./ddl-types-DrK8E0jL-Cz06w-Hd.mjs";
import { o as LowererContext } from "./ast-Cl_w2lbg.mjs";
import "./validators-CJSyNFS4.mjs";
import { g as SqlSchemaIR, v as SqlSchemaIRNode } from "./types-CHOgKgHg-BxgkL3GS.mjs";
import "./types-BijNazlM.mjs";
import { i as SqlControlAdapter } from "./control-adapter-C99J7aEF-jlK7uZyJ.mjs";
import { A as SqlPlannerSuccessResult, C as SqlMigrationRunnerSuccessValue, O as SqlPlannerFailureResult, T as SqlPlannerConflict, _ as SqlMigrationRunner, h as SqlMigrationPlanner, n as CodecControlHooks, r as CreateSqlMigrationPlanOptions, t as AnyRecord, u as SqlMigrationPlan, v as SqlMigrationRunnerErrorCode, x as SqlMigrationRunnerFailure } from "./types-BFPRCYGW-DeB_n96N.mjs";
import { t as SqlSchemaDiffFn } from "./schema-differ-DpG_gnur-CXVM1Oed.mjs";
import { AuthoringDataTypeEntry } from "@prisma/orm-framework/components/authoring";
...
import { ContributedPslDiagnosticCode, PslDocumentAst } from "@prisma/orm-framework/components/psl-ast";
    ...
    readonly type: {
      readonly sql: {
        readonly String: {
          ...
          readonly documentation: "Variable-length text with a required maximum character length.";
          readonly args: readonly [{
            readonly kind: "number";
    ...
    readonly attributeSpecs: {
      readonly model: {
        ...
        readonly base: () => import("@prisma/orm-framework/psl-parser").AttributeSpec<{
          base: import("@prisma/orm-framework/psl-parser").ResolvedEntityReference<import("@prisma/orm-framework/psl-parser").ModelSymbol>;
          value: string;
        }, import("@prisma/orm-framework/psl-parser").ModelAttributeCtx>;
      };
      readonly field: {
        ...
        readonly default: (ctx: import("@prisma/orm-framework/psl-parser").FieldAttributeSpecContext) => import("@prisma/orm-framework/psl-parser").AttributeSpec<{
          value: (string | boolean | import("@prisma/orm-framework/psl-parser").NumLiteral | import("@prisma/orm-framework/psl-parser").ParsedTaggedLiteral) | (string | boolean | import("@prisma/orm-framework/psl-parser").NumLiteral | import("@prisma/orm-framework/psl-parser").ParsedTaggedLiteral)[] | import("@prisma/orm-framework/psl-parser").TypedFuncCall;
        }, import("@prisma/orm-framework/psl-parser").FieldAttributeCtx>;
      };
    };
  };
...
//#endregion
//#region src/core/migrations/table-name-case-guard.d.ts
declare const TABLE_NAME_CASE_CHANGED_CODE = "MIGRATION.TABLE_NAME_CASE_CHANGED";
/** The one fact the guard needs about a table the plan would drop or create. */
interface TableNameCaseGuardTable {
  readonly name: string;
}
/**
 ...
 */
declare function detectTableNameCaseChanges(input: {
...
//#endregion
//#region src/core/sql-default-literal-tag.d.ts
/** A `` @default(sql`...`) `` body the SQL family refuses to lower. */
declare const PSL_INVALID_DEFAULT_SQL: ContributedPslDiagnosticCode;
/**
 ...
 */
declare function sqlDefaultLiteralTagEntry(tag: string): AuthoringDataTypeEntry;
//#endregion
...
declare function temporalStringAuthoringPresets<const CodecId extends string, const NativeType extends string, const GeneratorId extends string = typeof TIMESTAMP_NOW_GENERATOR_ID>(input: {
  readonly codecId: CodecId;
  readonly nativeType: NativeType;
  readonly generatorId?: GeneratorId;
}): {
...
//#endregion
export { controlPolicyForCall as A, runnerFailure as B, TableNameCaseGuardTable as C, buildNativeTypeExpander as D, assembleAuthoringContributions as E, partitionCallsByControlPolicy as F, temporalCodecPresetWithPrecision as G, sqlDefaultLiteralTagEntry as H, partitionIssuesByControlPolicy as I, temporalStringAuthoringPresets as K, planFieldEventOperations as L, detectDestructiveChanges as M, detectTableNameCaseChanges as N, contractNamespaceToSchemaIR as O, extractCodecControlHooks as P, plannerFailure as R, TIMESTAMP_NOW_GENERATOR_ID as S, _default as T, temporalAuthoringPresets as U, runnerSuccess as V, temporalCodecPreset as W, SqlControlFamilyInstance as _, EnumNamespaceSchemaResolver as a, SuppressionRecord as b, MigrationOperationPolicy$1 as c, MigrationPlanner as d, MigrationPlannerConflict$1 as f, PlanFieldEventOperationsOptions as g, PSL_INVALID_DEFAULT_SQL as h, DefaultResolver as i, createMigrationPlan as j, contractToSchemaIR as k, MigrationPlan$1 as l, NativeTypeExpander as m, ControlPolicySubject as n, INIT_ADDITIVE_POLICY as o, MigrationPlannerResult as p, timestampNowControlDescriptor as q, DefaultRenderer as r, MigrationOperationClass as s, ContractToSchemaIROptions as t, MigrationPlanOperation$1 as u, SqlControlTargetDescriptor as v, TargetMigrationsCapability as w, TABLE_NAME_CASE_CHANGED_CODE as x, SqlDescribedContractSpace as y, plannerSuccess as z };
//# sourceMappingURL=control-BS-GfNP5.d.mts.map