import { n as buildSqlContractFromDefinition, r as contractError, t as applySqlSpecifierControlPolicy } from "./derived-checks-6WZKIUxH-CWip2UN5.mjs";
	...
	return {
		source: {
			...
			load: async (context) => {
				...
				if (absolutePath === void 0) throw new InternalError("typescriptContractFromPath: context.resolvedInputs is empty. The CLI config loader should populate it from source.inputs.");
...
//# sourceMappingURL=config-types-DLERgC8A.mjs.map