...
declare abstract class SqlContractSerializerBase<TContract extends Contract<SqlStorage>> implements ContractSerializer<TContract> {
  ...
  hashCanonicalizationHooks: {
    readonly shouldPreserveEmpty: import("@prisma/orm-framework/contract/hashing").PreserveEmptyPredicate;
    readonly sortStorage: import("@prisma/orm-framework/contract/hashing").StorageSort;
  };
...
//# sourceMappingURL=ir-BJ-dsbe-.d.mts.map