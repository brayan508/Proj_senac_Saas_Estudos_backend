...
import { v as SqlSchemaIRNode } from "./types-CHOgKgHg-BxgkL3GS.mjs";
...
//#region ../../../2-sql/9-family/dist/types-BFPRCYGW.d.mts
...
type SqlPlannerConflictKind = 'typeMismatch' | 'nullabilityConflict' | 'indexIncompatible' | 'rlsPolicyIncompatible' | 'foreignKeyConflict' | 'missingButNonAdditive' | 'unsupportedOperation' | 'controlPolicySuppressedCall' | 'tableNameCaseChanged';
...
//# sourceMappingURL=types-BFPRCYGW-DeB_n96N.d.mts.map