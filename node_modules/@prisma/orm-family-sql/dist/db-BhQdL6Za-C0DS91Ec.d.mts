...
import { o as StorageColumnMapAt } from "./types-C36_3E6_.mjs";
import { Dt as SelectAst, l as AnyFromSource } from "./types-YGX78yVc-LY1JQLED.mjs";
import "./ast-Cl_w2lbg.mjs";
import { n as SqlQueryPlan } from "./plan-DVkrl9Pq-CUhH48Gt.mjs";
import { S as TraitExpression, c as RawAffectedCountQuery, f as RawRowQuery, g as RawSqlInterpolation, h as RawSqlBuilder, i as CodecTypesBase, o as Expression, r as CodecExpression, s as NoReservedRowColumn, x as ScopeField, y as RawSqlTag } from "./expression-DV56tQtp.mjs";
...
//#region ../../../2-sql/4-lanes/sql-builder/dist/db-BhQdL6Za.d.mts
...
type WhereFilter<C extends TableProxyContract, NsId extends keyof C['storage']['namespaces'] & string, Name extends TableNamesInNamespace<C, NsId>> = ExpressionBuilder<DefaultScope<Name, NamespaceTable<C, NsId, Name>>, ContractToQC<C, NsId, Name>>;
...
type TableNamesInNamespace<C extends TableProxyContract, NsId extends keyof C['storage']['namespaces']> = keyof TablesInNamespace<C['storage']['namespaces'][NsId]> & string;
...
//#endregion
export { UnboundTables as C, TableProxyContract as S, WhereFilter as T, SelectQuery as _, DeleteQuery as a, TableNamesAcrossNamespaces as b, GatedMethod as c, Namespace as d, QueryContext as f, Scope as g, ResolveRow as h, Db as i, GroupedQuery as l, RawTagFor as m, BooleanCodecType as n, FieldProxy as o, RawLane as p, ContractRawTag as r, Functions as s, AggregateFunctions as t, InsertQuery as u, Subquery as v, UpdateQuery as w, TableProxy as x, TableInAnyNamespace as y };
//# sourceMappingURL=db-BhQdL6Za-C0DS91Ec.d.mts.map