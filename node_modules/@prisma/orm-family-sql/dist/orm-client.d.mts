...
import { E as CodecRef$1, Lt as WhereArg, _ as BinaryExpr, _t as OrderByItem, a as AndExpr, c as AnyExpression, gt as OrExpr, mt as NullCheckExpr, r as AggregateFn, st as LimitOffsetValue } from "./types-YGX78yVc-LY1JQLED.mjs";
import "./ast-Cl_w2lbg.mjs";
import { n as SqlQueryPlan, t as Preparable } from "./plan-DVkrl9Pq-CUhH48Gt.mjs";
import { S as TraitExpression, i as CodecTypesBase, o as Expression } from "./expression-DV56tQtp.mjs";
import "./plan-Dh-FnySu.mjs";
import { r as ExecutionContext } from "./query-lane-context-BUNC86DS-554MXNHX.mjs";
import "./query-lane-context-Cj8AWGMg.mjs";
import { h as RuntimeScope, o as ComputeColumnJsType } from "./types-_3eY-tTq-DY2fDu2J.mjs";
import "./types-BvpZI6y1.mjs";
import { T as RuntimeQueryable$1, l as ParamsFromDeclaration, m as PreparedStatement, p as PreparedFor, r as Declaration, t as BindSiteParams, y as Runtime } from "./prepared-statement-B6zvhJej-CAzfySgB.mjs";
import "./index-DTvblzjn.mjs";
import { Contract } from "@prisma/orm-framework/contract/types";
import { AnnotationValue, AsyncIterableResult, MetaBuilder, OperationKind, ResultType, RuntimeExecuteOptions } from "@prisma/orm-framework/components/runtime";
...
type PredicateOperand<T, CodecId extends string> = T | Expression<{
  codecId: CodecId;
  nullable: false;
  many?: never;
}>;
type ComparisonMethodFns<T, CodecId extends string = never> = {
  eq(value: T | Expression<{
    codecId: CodecId;
    nullable: boolean;
    many?: never;
  }>): AnyExpression;
  neq(value: T | Expression<{
    codecId: CodecId;
    nullable: boolean;
    many?: never;
  }>): AnyExpression;
 ...
 */
type ComparisonMethods<T, Traits, CodecId extends string = never> = { [K in keyof ComparisonMethodsMeta as [ComparisonMethodsMeta[K]['traits'][number]] extends [Traits] ? K : never]: ComparisonMethodFns<PredicateOperand<T, CodecId>, CodecId>[K]; };
...
type DomainNamespaceId<TContract extends Contract<SqlStorage>> = keyof TContract['domain']['namespaces'] & string;
type RelationPredicate<TContract extends Contract<SqlStorage>, NsId extends DomainNamespaceId<TContract>, ModelName extends string> = (model: ModelAccessor<TContract, ModelName, NsId>) => AnyExpression;
type RelationPredicateInput<TContract extends Contract<SqlStorage>, NsId extends DomainNamespaceId<TContract>, ModelName extends string> = RelationPredicate<TContract, NsId, ModelName> | Record<string, unknown>;
type RelationFilterAccessor<TContract extends Contract<SqlStorage>, RelatedNsId extends DomainNamespaceId<TContract>, RelatedModelName extends string> = {
...
}> & ComparisonMethods<FieldJsType<TContract, ModelName, K, NsId>, FieldTraits<TContract, ModelName, K, NsId>, FieldCodecId<TContract, ModelName, K, NsId>> & FieldOperations<TContract, NsId, ModelName, K>; };
type RelationModelAccessor<TContract extends Contract<SqlStorage>, ModelName extends string, NsId extends string = never> = { [K in RelationNames<TContract, ModelName, NsId>]: RelationFilterAccessor<TContract, RelationTargetNamespace<TContract, ModelName, K, NsId>, RelatedModelName<TContract, ModelName, K, NsId> & string>; };
type ModelAccessor<TContract extends Contract<SqlStorage>, ModelName extends string, NsId extends string = never> = ScalarModelAccessor<TContract, ModelName, NsId> & RelationModelAccessor<TContract, ModelName, NsId>;
/**
...
type HavingComparisonMethods<T, CodecId extends string = never> = Pick<ComparisonMethods<T, 'equality' | 'order', CodecId>, 'eq' | 'neq' | 'gt' | 'lt' | 'gte' | 'lte'>;
/**
...
type AggregateOutputCodecId<Row> = Row extends {
  readonly output: infer Id extends string;
} ? Id : never;
type FieldHavingCall<TContract extends Contract<SqlStorage>, ModelName extends string, Op extends string, NsId extends string> = <FieldName extends AggregateFieldNames<TContract, ModelName, Op, NsId>>(field: FieldName) => HavingComparisonMethods<number | null, AggregateOutputCodecId<AggregateRowFor<TContract, Op, FieldCodecId<TContract, ModelName, FieldName, NsId>>>>;
type HavingMethod<TContract extends Contract<SqlStorage>, ModelName extends string, Op extends string, NsId extends string> = HasZeroArgCall<TContract, Op> extends true ? {
  (): HavingComparisonMethods<HavingZeroArgComparand<AggregateRowFor<TContract, Op, never>>, AggregateOutputCodecId<AggregateRowFor<TContract, Op, never>>>;
  <FieldName extends AggregateFieldNames<TContract, ModelName, Op, NsId>>(field: FieldName): HavingComparisonMethods<number | null, AggregateOutputCodecId<AggregateRowFor<TContract, Op, FieldCodecId<TContract, ModelName, FieldName, NsId>>>>;
...
type ShorthandWhereFilter<TContract extends Contract<SqlStorage>, NsId extends DomainNamespaceId<TContract>, ModelName extends string> = Partial<{ [K in keyof DefaultModelRow<TContract, ModelName, NsId> & string]: DefaultModelRow<TContract, ModelName, NsId>[K] | ('equality' extends FieldTraits<TContract, ModelName, K, NsId> ? Expression<{
  codecId: FieldCodecId<TContract, ModelName, K, NsId>;
  nullable: boolean;
  many?: never;
...
type ScalarCreateInput<TContract extends Contract<SqlStorage>, ModelName extends string, NsId extends string = never> = Pick<DefaultModelRow<TContract, ModelName, NsId>, RequiredCreateFieldNames<TContract, ModelName, NsId>> & Partial<Pick<DefaultModelRow<TContract, ModelName, NsId>, OptionalCreateFieldNames<TContract, ModelName, NsId>>>;
type CreateInput<TContract extends Contract<SqlStorage>, ModelName extends string, NsId extends string = never> = ScalarCreateInput<TContract, ModelName, NsId> & RelationMutationFields<TContract, ModelName, 'create'>;
...
type ResolvedScalarCreateInput<TContract extends Contract<SqlStorage>, ModelName extends string, VName extends string | undefined, NsId extends string = never> = IsPolymorphicBase<TContract, ModelName, NsId> extends true ? VName extends string ? Omit<ScalarCreateInput<TContract, ModelName, NsId>, DiscriminatorFieldName<TContract, ModelName, NsId>> & ScalarCreateInput<TContract, VName, NsId> : never : ScalarCreateInput<TContract, ModelName, NsId>;
...
type ContractNamespaceKey<TContract extends Contract<SqlStorage>, NsId extends string> = { [K in keyof TContract['domain']['namespaces'] & string]: NsId extends K ? K : never; }[keyof TContract['domain']['namespaces'] & string];
...
} ? ContractNamespaceKey<TContract, N> : never : never : never : never;
...
type IsToOneRelationNullable<TContract extends Contract<SqlStorage>, ModelName extends string, RelName extends string, NsId extends string = never> = RelationsOf<TContract, ModelName, NsId> extends (infer Rels extends Record<string, unknown>) ? RelName extends keyof Rels ? Rels[RelName] extends {
...
} ? V : RefinedIncludeRelationValue<TContract, ParentModelName, RelName, V, NsId> : IncludeRelationValue<TContract, ParentModelName, RelName, DefaultIncludedRow, NsId>;
/**
 ...
 */
type RefinedIncludeRelationValue<TContract extends Contract<SqlStorage>, ParentModelName extends string, RelName extends string, IncludedRow, NsId extends string = never> = RelationCardinality<TContract, ParentModelName, RelName, NsId> extends '1:1' | 'N:1' ? IncludedRow | null : IncludedRow[];
type WhereInput<TContract extends Contract<SqlStorage>, NsId extends string, ModelName extends string, VariantName extends string | undefined = undefined> = ((model: VariantAwareModelAccessor<TContract, ModelName, VariantName, NsId>) => WhereArg) | ShorthandWhereFilter<TContract, NsId, ModelName>;
//#endregion
...
declare class GroupedCollection<TContract extends Contract<SqlStorage>, ModelName extends string, GroupFields extends readonly GroupByFieldName<TContract, ModelName, NsId>[], NsId extends string = never, HasOrderBy extends boolean = false> {
   ...
   */
  limit(n: HasOrderBy extends true ? number | TraitExpression<readonly ['numeric'], false, ExtractCodecTypes<TContract>> : never): GroupedCollection<TContract, ModelName, GroupFields, NsId, HasOrderBy>;
  /**
   ...
   */
  offset(n: HasOrderBy extends true ? number | TraitExpression<readonly ['numeric'], false, ExtractCodecTypes<TContract>> : never): GroupedCollection<TContract, ModelName, GroupFields, NsId, HasOrderBy>;
  /**
   ...
   */
  get prepared(): {
    aggregate: <Spec extends AggregateSpec>(fn: (aggregate: AggregateBuilder<TContract, ModelName, NsId>) => Spec, configure?: (meta: MetaBuilder<"read">) => void) => Preparable<Record<string, unknown>, Promise<SimplifyDeep<Pick<DefaultModelRow<TContract, ModelName, NsId>, GroupFields[number]> & AggregateResult<Spec>>[]>>;
  };
...
//#endregion
//#region src/prepared-collection.d.ts
interface PreparedCollection<TContract extends Contract<SqlStorage>, ModelName extends string, Row, State extends CollectionTypeState> {
  aggregate<Spec extends AggregateSpec>(selector: (aggregate: AggregateBuilder<TContract, ModelName, State['nsId']>) => Spec, configure?: (meta: MetaBuilder<'read'>) => void): Preparable<Record<string, unknown>, Promise<AggregateResult<Spec>>>;
  all(configure?: (meta: MetaBuilder<'read'>) => void): Preparable<Record<string, unknown>, AsyncIterableResult<Row>>;
  first(): Preparable<Record<string, unknown>, Promise<Row | null>>;
  first(filter: undefined, configure: (meta: MetaBuilder<'read'>) => void): Preparable<Record<string, unknown>, Promise<Row | null>>;
  first(filter: WhereInput<TContract, State['nsId'], ModelName, State['variantName']>, configure?: (meta: MetaBuilder<'read'>) => void): Preparable<Record<string, unknown>, Promise<Row | null>>;
}
//#endregion
 ...
 */
interface CreateConflictOptions<TContract extends Contract<SqlStorage>, ModelName extends string> {
...
declare class CollectionImpl<TContract extends Contract<SqlStorage>, ModelName extends string, Row = SimplifyDeep<InferRootRow<TContract, ModelName>>, State extends CollectionTypeState = DefaultCollectionTypeState> implements RowSelection<Row> {
  ...
  where(filters: ShorthandWhereFilter<TContract, State['nsId'], ModelName>): Collection<TContract, ModelName, Row, WithWhereState<State>>;
  /**
   ...
   * ```
   */
  orderBy(selection: ((model: VariantAwareModelAccessor<TContract, ModelName, State['variantName'], State['nsId']>) => OrderByItem) | ReadonlyArray<(model: VariantAwareModelAccessor<TContract, ModelName, State['variantName'], State['nsId']>) => OrderByItem>): Collection<TContract, ModelName, Row, WithOrderByState<State>>;
  /**
   ...
   * ```
   */
  limit(n: number | TraitExpression<readonly ['numeric'], false, ExtractCodecTypes<TContract>>): Collection<TContract, ModelName, Row, State>;
  /**
   ...
   * ```
   */
  offset(n: number | TraitExpression<readonly ['numeric'], false, ExtractCodecTypes<TContract>>): Collection<TContract, ModelName, Row, State>;
  /**
  ...
  first(filter: WhereInput<TContract, State['nsId'], ModelName, State['variantName']>, configure?: (meta: MetaBuilder<'read'>) => void): Promise<Row | null>;
  /**
   ...
   */
  createAll(data: readonly ResolvedScalarCreateInput<TContract, ModelName, State['variantName'], State['nsId']>[], optionsOrConfigure?: CreateConflictOptions<TContract, ModelName> | WriteConfigure, configure?: WriteConfigure): AsyncIterableResult<Row>;
  /**
   ...
   */
  createAndCount(data: readonly ResolvedScalarCreateInput<TContract, ModelName, State['variantName'], State['nsId']>[], optionsOrConfigure?: CreateConflictOptions<TContract, ModelName> | WriteConfigure, configure?: WriteConfigure): Promise<number>;
  /**
...
declare function createModelAccessor<TContract extends Contract<SqlStorage>, ModelName extends string, VariantName extends string | undefined = undefined, NsId extends string = string>(context: ExecutionContext<TContract>, namespaceId: NsId, modelName: ModelName, variantName?: VariantName): VariantAwareModelAccessor<TContract, ModelName, VariantName, NsId>;
//#endregion
//#region src/orm.d.ts
...
//#endregion
//#region src/prepared-row-query.d.ts
interface PreparedRowQuery<Params, Result> {
  query(target: RuntimeQueryable$1, params: Params, options?: RuntimeExecuteOptions): Result;
}
type PreparedFrom<Params, Q extends SqlQueryPlan | Preparable<unknown, unknown>> = Q extends Preparable<unknown, infer Result> ? PreparedRowQuery<Params, Result> : PreparedFor<Params, ResultType<Q>>;
declare function prepareQuery<D extends Declaration<CT>, Q extends SqlQueryPlan | Preparable<unknown, unknown>, CT extends CodecTypesBase>(runtime: Runtime, declaration: D, callback: (params: BindSiteParams<D>) => Q): Promise<PreparedFrom<ParamsFromDeclaration<D, CT>, Q>>;
declare function createPreparedRowQuery<Params, DbRow, Result>(description: Preparable<DbRow, Result>, statement: PreparedStatement<Params, DbRow>): PreparedRowQuery<Params, Result>;
//#endregion
export { type AggregateBuilder, type AggregateResult, type AggregateSpec, Collection, type CollectionContext, type CollectionModelName, type CollectionState, type CollectionTypeState, type ComparisonMethods, type CreateInput, type DefaultCollectionTypeState, type DefaultModelRow, GroupedCollection, type IncludeExpr, type ModelAccessor, type NumericFieldNames, type OrmOptions, type PreparedCollection, type PreparedFrom, type PreparedRowQuery, type RelatedModelName, type RelationFilterAccessor, type RelationMutator, type RelationNames, type RelationPredicate, type RelationPredicateInput, type RelationsOf, type RuntimeQueryable, type ShorthandWhereFilter, type UniqueConstraintCriterion, all, and, createModelAccessor, createPreparedRowQuery, emptyState, not, or, orm, prepareQuery };
