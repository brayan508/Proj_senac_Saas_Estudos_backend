import { A as PG_TIME_TEMPORAL_CODEC_ID, B as SQL_VARCHAR_CODEC_ID, C as PG_TIMESTAMPTZ_DATE_CODEC_ID, D as PG_TIMESTAMP_TEMPORAL_CODEC_ID, E as PG_TIMESTAMP_STRING_CODEC_ID, F as PG_VARCHAR_CODEC_ID, I as SQL_CHAR_CODEC_ID, L as SQL_FLOAT_CODEC_ID, N as PG_UUID_CODEC_ID, O as PG_TIMETZ_CODEC_ID, P as PG_VARBIT_CODEC_ID, R as SQL_INT_CODEC_ID, S as PG_TEXT_CODEC_ID, T as PG_TIMESTAMPTZ_TEMPORAL_CODEC_ID, _ as PG_INT_CODEC_ID, a as PG_DATE_STRING_CODEC_ID, b as PG_NUMERIC_CODEC_ID, c as PG_FLOAT4_CODEC_ID, d as PG_INET_CODEC_ID, f as PG_INT2_CODEC_ID, g as PG_INTERVAL_CODEC_ID, i as PG_CHAR_CODEC_ID, k as PG_TIME_STRING_CODEC_ID, l as PG_FLOAT8_CODEC_ID, m as PG_INT8_CODEC_ID, n as PG_BOOL_CODEC_ID, o as PG_DATE_TEMPORAL_CODEC_ID, p as PG_INT4_CODEC_ID, r as PG_BYTEA_CODEC_ID, t as PG_BIT_CODEC_ID, u as PG_FLOAT_CODEC_ID, v as PG_JSONB_CODEC_ID, w as PG_TIMESTAMPTZ_STRING_CODEC_ID, y as PG_JSON_CODEC_ID, z as SQL_TEXT_CODEC_ID } from "./codec-ids-Cb0yO-IS--e0P2rfI.mjs";
import { t as postgresAggregateDescriptors } from "./aggregates-B6ZQFHFE.mjs";
import { D as postgresDataTypes } from "./data-types-BOMKl3ue-BZ8EARvV.mjs";
import { n as postgresCodecRegistry } from "./registry-Bf5BvREu-DJ7g3REJ.mjs";
import { t as adapterError } from "./sql-renderer-BnTqIzZw-C8YDKp4u.mjs";
//#region ../../../3-targets/6-adapters/postgres/dist/descriptor-meta-ClQ1wGLk.mjs
...
function expandPrecision({ nativeType, typeParams }) {
	...
	if (!isNonNegativeInteger(precision)) throw adapterError("RUNTIME.TYPE_PARAMS_INVALID", `Invalid "precision" type parameter for "${nativeType}": expected a non-negative integer, got ${JSON.stringify(precision)}`, { meta: {
		nativeType,
		param: "precision",
		received: precision
	} });
...
//#endregion
export { postgresAdapterDescriptorMeta as t };

//# sourceMappingURL=descriptor-meta-ClQ1wGLk-BDPciTA3.mjs.map