...
//#region ../../../3-targets/3-targets/postgres/dist/codec-descriptor-BfoHQP3R.mjs
...
function isPostgresCodecDescriptor(value) {
	return typeof value === "object" && value !== null && "descriptorKind" in value && value.descriptorKind === POSTGRES_CODEC_DESCRIPTOR_KIND && "codecId" in value && typeof value.codecId === "string" && "traits" in value && Array.isArray(value.traits) && "targetTypes" in value && Array.isArray(value.targetTypes) && value.targetTypes.every((targetType) => typeof targetType === "string") && "paramsSchema" in value && (value.paramsSchema === void 0 || isObjectLike(value.paramsSchema) && "~standard" in value.paramsSchema && isObjectLike(value.paramsSchema["~standard"]) && "validate" in value.paramsSchema["~standard"] && typeof value.paramsSchema["~standard"].validate === "function") && "isParameterized" in value && typeof value.isParameterized === "boolean" && "factory" in value && typeof value.factory === "function" && "nativeTypeFor" in value && typeof value.nativeTypeFor === "function" && "projectJson" in value && typeof value.projectJson === "function";
}
...
//# sourceMappingURL=codec-descriptor-BfoHQP3R-CMRVT-F6.mjs.map