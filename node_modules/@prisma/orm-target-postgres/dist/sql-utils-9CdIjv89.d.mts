...
//#region ../../../3-targets/3-targets/postgres/dist/sql-utils.d.mts
//#region src/core/full-text-index-expression.d.ts
/**
 ...
 */
declare function renderFullTextIndexExpression(language: FullTextSearchLanguage, columnName: string): string;
/**
 ...
 */
declare function isFullTextIndexableCodec(codecId: string): boolean;
//#endregion
 ...
 */
declare function quoteQualifiedName(name: string): string;
/**
...
//#endregion
export { quoteQualifiedName as a, quoteIdentifier as i, isFullTextIndexableCodec as n, renderFullTextIndexExpression as o, qualifyName as r, validateEnumValueLength as s, escapeLiteral as t };
//# sourceMappingURL=sql-utils-9CdIjv89.d.mts.map