...
import { i as isPgEnumParams } from "./codecs-BkaZXa9Y-C8o9DOKH.mjs";
...
import { checkSqlDefaultBody } from "@prisma/orm-family-sql/family/control";
//#region ../../../3-targets/3-targets/postgres/dist/planner-ddl-builders-TSrD4_Aw.mjs
/**
...
function assertSafeDefaultExpression(expression) {
	if (checkSqlDefaultBody(expression) !== void 0) throw postgresError("CONTRACT.DEFAULT_INVALID", `Unsafe default expression in contract: "${expression}". Default expressions must not contain semicolons, SQL comment tokens, dollar-quoting, or subqueries.`, { meta: { expression } });
}
/**
...
function renderDefaultLiteral(value, column) {
	...
	if (column?.many && Array.isArray(value)) return renderArrayLiteralDefault(value, column.nativeType);
...
*/
function renderArrayLiteralDefault(elements, nativeType) {
...
//# sourceMappingURL=planner-ddl-builders-TSrD4_Aw-CfVU1uui.mjs.map