...
import { StorageColumn, StorageTypeInstance } from "@prisma/orm-family-sql/contract/types";
import { CodecControlHooks } from "@prisma/orm-family-sql/family/control";
//#region ../../../3-targets/3-targets/postgres/dist/planner-ddl-builders.d.mts
 ...
 */
declare function buildColumnTypeSql(column: Pick<StorageColumn, 'nativeType' | 'codecId' | 'many' | 'typeParams' | 'typeRef' | 'default'>, codecHooks: ReadonlyMap<string, CodecControlHooks>, storageTypes?: Record<string, StorageTypeInstance>, allowPseudoTypes?: boolean): string;
...
//# sourceMappingURL=planner-ddl-builders-bBCUsq_0.d.mts.map