...
//#region ../../../3-targets/7-drivers/postgres/dist/temporal-text-parsers-M28a91UF.mjs
...
const PG_TYPES_ARRAY_OIDS = /* @__PURE__ */ new Set([
	651,
	791,
	199,
	1e3,
...
function createTextTypes(rawTextOids) {
	return { getTypeParser(oid, format) {
		if (rawTextOids.has(oid)) return serverText;
		return getTypeParser(oid, format);
	} };
}
const controlTextTypes = createTextTypes(PG_TYPES_ARRAY_OIDS);
const temporalTextTypes = createTextTypes(/* @__PURE__ */ new Set([...TEMPORAL_SCALAR_OIDS, ...PG_TYPES_ARRAY_OIDS]));
//#endregion
export { postgresDriverDescriptorMeta as a, normalizePgError as i, isAlreadyConnectedError as n, temporalTextTypes as o, isPostgresError as r, controlTextTypes as t };

//# sourceMappingURL=temporal-text-parsers-M28a91UF-D938VcZK.mjs.map