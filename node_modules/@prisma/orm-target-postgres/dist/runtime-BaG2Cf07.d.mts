import "./plain-date-time-now-generator-DJ3icyVr-B-rdIVd3.mjs";
...
import { SqlNamespaceInput, SqlStorage } from "@prisma/orm-family-sql/contract/types";
...
import { RuntimeTargetDescriptor, RuntimeTargetInstance } from "@prisma/orm-framework/components/execution";
import { SqlOperationDescriptors } from "@prisma/orm-family-sql/operations";
import { PreserveEmptyPredicate } from "@prisma/orm-framework/contract/hashing";
import { JsonObject } from "@prisma/orm-framework/utils/json";
//#region ../../../3-targets/3-targets/postgres/dist/runtime.d.mts
...
type PostgresListDecoder = (wireValue: unknown, decodeElement: (value: unknown) => Promise<unknown>) => Promise<readonly unknown[]>;
/**
...
//#endregion
export { postgresRuntimeTargetDescriptor as i, PostgresListDecoder as n, PostgresRuntimeTargetInstance as r, PostgresContractSerializer as t };
//# sourceMappingURL=runtime-BaG2Cf07.d.mts.map